...
namespace IgneelD3D10 {
	...
	ShaderType GetPType(D3D10_SHADER_VARIABLE_TYPE c)
	{
		switch (c)
		{
		case D3D_SVT_VOID: return ShaderType::Unsupported;//ParameterType::VOID;
		case D3D_SVT_BOOL: return ShaderType::Bool;
		case D3D_SVT_INT:   return ShaderType::Int;
		case D3D_SVT_FLOAT:  return ShaderType::Float;	
		case D3D_SVT_TEXTURE:  return ShaderType::Texture;
		case D3D_SVT_TEXTURE1D:  return ShaderType::Texture1D;
		case D3D_SVT_TEXTURE2D:  return ShaderType::Texture2D;
		case D3D_SVT_TEXTURE3D:  return ShaderType::Texture3D;
		case D3D_SVT_SAMPLER:  return ShaderType::Sampler;
		case D3D_SVT_SAMPLER2D:  return ShaderType::Sampler2D;
		case D3D_SVT_SAMPLER3D:  return ShaderType::Sampler3D;
		case D3D_SVT_SAMPLERCUBE:  return ShaderType::SamplerCube;						
		default:
