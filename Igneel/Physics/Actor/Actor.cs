...
{
    public abstract class Actor : ResourceAllocator, INameable, IAssetProvider, IPositionable, ITranslatable, IRotable, IAffector , IGraphicObject
    {
        ...
        protected RenderBinder renderBinder;
        ...
        {
            return AutoAsset.Create(this, name);
        }       
        ...
        public void Draw()
        {
            Draw(null, Engine.GetRender<Actor>());
        }
