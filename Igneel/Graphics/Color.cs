...
{   
    ...
    public struct Color4:IEquatable<Color>
    {
        ...
        {
            this.A = (float)(((double)color.A) / 255.0);
            this.R = (float)(((double)color.R) / 255.0);
            this.G = (float)(((double)color.G) / 255.0);
            this.B = (float)(((double)color.B) / 255.0);
        }  
        ...
        {
            return Color.FromArgb((int)(this.A * 255.0), (int)(this.R * 255.0), (int)(this.G * 255.0), (int)(this.B * 255.0));
        }
        ...
        {
            Color4 v = value;
            v.R = Math.Min(1, Math.Max(0, value.R));
            v.G = Math.Min(1, Math.Max(0, value.G));
            v.B = Math.Min(1, Math.Max(0, value.B));
            v.A = Math.Min(1, Math.Max(0, value.A));
            return v;
        }
