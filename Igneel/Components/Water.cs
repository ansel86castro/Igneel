...
namespace Igneel.Components
{
    ...
    //        vBuffer = Engine.Graphics.CreateVertexBuffer<VertexPNTTx>(bufferSize, Usage.WriteOnly, VertexFormat.None, Pool.Managed);
    //        iBuffer = Engine.Graphics.CreateIndexBuffer(indexes.Length, Usage.WriteOnly, Pool.Managed, true);
    ...
    //    //    vBuffer = Engine.Graphics.CreateVertexBuffer<VertexPNTTx>(bufferSize, Usage.WriteOnly, VertexFormat.None, Pool.Default);
    //    //    iBuffer = Engine.Graphics.CreateIndexBuffer(indexes.Length, Usage.WriteOnly, Pool.Default, true);
