...
namespace Igneel.Components
{
    ...
    public class SkyDome:GraphicObject<SkyDome>,IInitializable
    {
        ...
        public void Initialize()
        {
            ...
            vd = VertexDescriptor.GetDescriptor<VertexP>(); // new VertexDescriptor(new VertexDeclaration(GEngine.Graphics, VertexP.Elements));
            ...
            ib = Engine.Graphics.CreateIndexBuffer(data: this.indices);
        }
