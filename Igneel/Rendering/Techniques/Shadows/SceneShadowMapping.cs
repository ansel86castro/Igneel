...
{
    public class SceneShadowMapping : SceneTechnique { }

    public class RenderShadowFactorTechnique : SceneTechnique 
    {
        public override void Apply()
        {
            ...
            //SceneTechnique.RenderSceneRenderList(scene.RenderList, true);
            SceneTechnique.RenderScene(true);
        }
    }

    public class DepthSceneRender : SceneTechnique
    {
        public override void Apply()
        {
            var scene = Engine.Scene;
            ...
            SceneTechnique.RenderSceneRenderList(scene.RenderList, false);
        }
    }
    ...
    //                            var state = Engine.Shadow.SofShadowState;
