...
namespace Igneel.Rendering
{
    ...
    public class ShadowMapTechnique : BindedSceneNodeTechnique<ShadowMapTechnique> ,IDeferreable
    {
        ...
        public ShadowMapTechnique(int size)         
        {
            ...
            this.size = size;
            this.bias = Engine.Shadow.ShadowMapping.Bias;

            Initialize();
        }

        public ShadowMapTechnique() :
            this(Engine.Shadow.ShadowMapping.Size)
        { }
        ...
        public void Initialize()
        {
            ...
            texCoordOffset = new Vector4[Engine.Shadow.ShadowMapping.PCFBlurSize * Engine.Shadow.ShadowMapping.PCFBlurSize];
            texCoordWeights = new float[Engine.Shadow.ShadowMapping.PCFBlurSize * Engine.Shadow.ShadowMapping.PCFBlurSize];
        ...
        {
            if (Engine.Shadow.Enable && (isDynamic || rendered))
            {                
        ...
        private void GenerateSamples()
        {
            ...
            var smState = Engine.Shadow.ShadowMapping;           
