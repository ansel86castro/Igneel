...
{
    public class TranslationGlypHitTestEffect:Igneel.Rendering.Effect
    {
        public TranslationGlypHitTestEffect(GraphicDevice device)
            : base(device) { }
        ...
        protected override TechniqueDesc[] GetTechniques()
        {
            return new TechniqueDesc[]{
                Tech("tech0")
                    .Pass<VertexPositionColor>("TranslationGlypVS", "Mesh_IdRenderPS")
            };
        }
