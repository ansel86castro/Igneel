...
namespace Igneel
{
    ...
    public struct Vector4:IEquatable<Vector4>
    {
        ...
        #region Conversorts
        public static explicit operator Quaternion(Vector4 a)
        {
            unsafe
            {
                return (*(Quaternion*)&a);
        ...
        public static explicit operator Vector2(Vector4 a)
        {
            unsafe
            {
                return (*(Vector2*)&a);
        ...
        public static implicit operator Color4(Vector4 a)
        {
            unsafe
            {
                return *(Color4*)&a;
        ...
        public static explicit operator Plane(Vector4 a)
        {
            unsafe
            {
                return (*(Plane*)&a);
        ...
        public static Vector4 Saturate(Vector4 value)
        {
            ...
            v.W = Math.Min(1, Math.Max(0, value.W));
            return v;
        }
