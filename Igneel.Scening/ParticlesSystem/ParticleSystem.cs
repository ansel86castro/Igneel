...
namespace Igneel.Scenering
{
    ...
    public class ParticleSystem : GraphicObject<ParticleSystem>, INameable,IDynamic
    {
        ...
        private void InitParticles()
        {
            ...
            vb = GraphicDeviceFactory.Device.CreateVertexBuffer(ResourceUsage.Dynamic, CpuAccessFlags.Write, data:quads);
            ib =  GraphicDeviceFactory.Device.CreateIndexBuffer(data: indices);            
        }
