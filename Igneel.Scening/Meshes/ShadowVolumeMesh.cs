...
namespace Igneel.Scenering
{
    ...
    //    {
    //        this.model = model;
    //        vd = Geometry.GetVertexDescriptor<ShadowVertex>(GGraphicDeviceFactory.Device);
    ...
    //        vb =GGraphicDeviceFactory.Device.CreateVertexBuffer<ShadowVertex>(shadowVertexes.Length, Usage.WriteOnly, VertexFormat.None, Pool.Default);
    //        vb.SetData(shadowVertexes);            

    //        ib =GGraphicDeviceFactory.Device.CreateIndexBuffer(shadowIndices.Length, Usage.WriteOnly, Pool.Default,true);
    ...
    //    {
    //        this.model = model;
    //        this.vd = Geometry.GetVertexDescriptor<VertexP>(GGraphicDeviceFactory.Device);
    ...
    //        //Mesh m = new Mesh(meshIndices.Length / 3, meshVertexes.Length, MeshFlags.SystemMemory, VertexFormats.Position, GGraphicDeviceFactory.Device);
    ...
    //        if (numVertices > 0)
    //        {
    //            Device device = GGraphicDeviceFactory.Device;
    ...
    //        EXTRUDE_BIAS = GSceneManager.Scene.ActiveCamera.FarClipPlane + Vector3.Distance(container.Model.Position , GSceneManager.Scene.ActiveCamera.Position);
