...
namespace Igneel.Scenering
{
    ...
    {       
            ...
            where T : struct
        {
            ...
            vb = GraphicDeviceFactory.Device.CreateVertexBuffer<T>(vd.Size, usage, cpuAccess, data: vertexes);
        }
        public void CreateVertexBuffer(Array vertexes, int vertexCount, ResourceUsage usage = ResourceUsage.Default, CpuAccessFlags cpuAccess = CpuAccessFlags.ReadWrite)        
        {
            ...
            vb = GraphicDeviceFactory.Device.CreateVertexBuffer(size, vd.Size, vertexes, usage, cpuAccess);
        }      
            ...
            where T : struct
        {
            ...
            ib = GraphicDeviceFactory.Device.CreateIndexBuffer<T>(usage, cpuAccess, indices);
        }
        ...
        {          
            ...
            ib = GraphicDeviceFactory.Device.CreateIndexBuffer(indices.Length, indices, format, usage, cpuAccess);            
        }    
