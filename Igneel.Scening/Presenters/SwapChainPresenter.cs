...
namespace Igneel.Rendering
{
    ...
    {        
        ...
        public SwapChainPresenter(IGraphicContext context)
        {
            ...
            swapChain = GraphicDeviceFactory.Device.CreateSwapChain(context);

            depthBuffer = GraphicDeviceFactory.Device.CreateDepthStencil(
        ...
        private void OnSizeChanged(Size size)
        {
            ...
            depthBuffer = GraphicDeviceFactory.Device.CreateDepthStencil(size.Width, size.Height, depthStencilFormat, msaa);
        }
