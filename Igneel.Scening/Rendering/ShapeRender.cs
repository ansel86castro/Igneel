...
namespace Igneel.Rendering
{
    public class ShapeRender<T>where T:struct
    {
        ...
        {
            if (SceneManager.Scene == null || SceneManager.Scene.ActiveCamera == null)
                return;
            ...
            //effect.SetViewProjMatrix(SceneManager.Scene.ActiveCamera.ViewProj);
        ...
        public void Render(ComposedShape<T> composeShape, Matrix world)
        {
            ...
            //    effect.SetViewMatrix(SceneManager.Scene.ActiveCamera.View);
            //    effect.SetValueByName("Proj", SceneManager.Scene.ActiveCamera.Projection);
            //}
            //else
            //{
            //    effect.Technique = technique;
