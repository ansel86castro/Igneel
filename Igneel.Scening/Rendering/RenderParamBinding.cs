...
namespace Igneel.Rendering
{
    ...
    public abstract class RenderBinder : IAssetProvider
    {
        ...
        public abstract IGraphicObjectRender<TComp> GetInstanceRender<TComp ,TShader>() where TComp : IGraphicObject;

        public abstract void SetInstanceRender<TComp, TShader>(IGraphicObjectRender<TComp> render) where TComp : IGraphicObject;
    ...
    public sealed class RenderBinder<T> : RenderBinder where T : IAssetProvider
    {
        ...
        {
            public static IGraphicObjectRender<TComp> Render;
        }
        ...
        public override IGraphicObjectRender<TComp> GetInstanceRender<TComp, TShader>()
        {
            return InstanceRenderStorage<TComp,TShader>.Render;
        }

        public override void SetInstanceRender<TComp, TShader>(IGraphicObjectRender<TComp> render)
        {
