...
namespace Igneel.Rendering
{
        ...
        where T : Effect
    {
            ...
            :base()
        {
            ...
            rastState = GraphicDeviceFactory.Device.CreateRasterizerState(new RasterizerDesc
            {
                 Cull = CullMode.None
            });
        }      
        ...
        public override void Draw(BillBoard component)
        {
            ...
            map.World = component.GetBillboardMatrix(SceneManager.Scene.ActiveCamera, Node.GlobalPosition, Node.LocalScale);
            map.WorldViewProj = map.World * SceneManager.Scene.ActiveCamera.ViewProj;
            map.ViewProj = SceneManager.Scene.ActiveCamera.ViewProj;
