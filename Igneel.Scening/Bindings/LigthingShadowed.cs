...
namespace Igneel.Scenering.Bindings
{
    public class ShadowMapBinding : RenderBinding<ShadowMapTechnique>      
    {
        ...
        public ShadowMapBinding() 
        {
            if (pointSampler == null)
                pointSampler = GraphicDeviceFactory.Device.CreateSamplerState(new SamplerDesc(true)
                {
        ...
        public override void OnBind(ShadowMapTechnique value)
        {
            if (EngineState.Shadow.Enable)
            {
                ...
                GraphicDeviceFactory.Device.PS.SetSampler(register, pointSampler);
            }
        }
    ...
    public class BuildSMapMatBinding : Igneel.Rendering.RenderBinding<MeshMaterial, IMeshMaterialMap>
    {        
