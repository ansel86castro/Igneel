...
SMVSOutputSoft SimpleVertexShader(float4 position : POSITION,
...
{
    SMVSOutputSoft output = (SMVSOutputSoft)0;
	...
	// float2 proj = output.PositionH.xy / output.PositionH.w;	
	TransformScreeen();	
...
SMBumpVSOutputSoft BumpVertexShader(float4 position : POSITION,
									float4  BlendWeights : BLENDWEIGHT,
								    float4  BlendIndices : BLENDINDICES,
									...
									uniform int NumBones)
{
	SMBumpVSOutputSoft output = (SMBumpVSOutputSoft)0;
...
PixelShader psShaders[8] = {            compile ps_3_0 PhongPixelShaderSSM(false, 0),
										compile ps_3_0 PhongPixelShaderSSM(false, 1),																				
										compile ps_3_0 PhongPixelShaderSSM(true, 0),
										compile ps_3_0 PhongPixelShaderSSM(true, 1),										
										
										compile ps_3_0 BumpPixelShaderSSM(false, 0),
										compile ps_3_0 BumpPixelShaderSSM(false, 1),																				
										compile ps_3_0 BumpPixelShaderSSM(true, 0),
										compile ps_3_0 BumpPixelShaderSSM(true, 1)										
							  };
  
							  
VertexShader skinnedVSArray[8] = {  compile vs_1_1 SimpleVertexShader(1), 
									compile vs_1_1 SimpleVertexShader(2),
									compile vs_1_1 SimpleVertexShader(3),
									compile vs_1_1 SimpleVertexShader(4),
									
								 	compile vs_1_1 BumpVertexShader(1), 
									compile vs_1_1 BumpVertexShader(2),
									compile vs_1_1 BumpVertexShader(3),
									compile vs_1_1 BumpVertexShader(4)
								 }; 
