...
namespace Igneel.Animations
{
    ...
    //[ResourceActivator(typeof(SceneNodeAnimContext.Activator))]
    public class FrameAnimationController:IEnabletable
    {
        ...
        {           
            //_frame.LocalPose = _initialLocalPose;         
        ...
        //{
        //    SceneNodeTransforms _transforms;
        //    AssetReference _nodeRef;

        //    public void Initialize(IAssetProvider provider)
        //    {
        //        var context = (SceneNodeAnimContext)provider;
        //        _transforms = context._transforms;
        //        _nodeRef = AssetManager.Instance.GetAssetReference(context._target);
        //    }

        //    public IAssetProvider OnCreateResource()
        //    {
        //        var node = (Frame)AssetManager.Instance.GetAssetProvider(_nodeRef);
        //        var context = (SceneNodeAnimContext)AnimationManager.GetContext<SceneNodeTransforms>(node);                
        //        context._targetName = node.Name;
        //        context._transforms = _transforms;
