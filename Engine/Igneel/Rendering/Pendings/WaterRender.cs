namespace Igneel.Rendering.Pendings
{
    ...
    //            format = EngineState.Lighting.HDR.Render.HRDFormat;
    ...
    //        OnLostDevice(GraphicDeviceFactory.Device);
    //        OnResetDevice(GraphicDeviceFactory.Device);
    //    }     
    ...
    //    {
    //        Surface backBuffer = GraphicDeviceFactory.Device.GetRenderTarget(0);
    ...
    //    {
    //        //if (enable && GEngineState.Lighting.ReflectionEnable)
    //        //{
    //        //    Water water = (Water)node;
    //        //    reflMatrix.M42 = 2 * water.Height;
    //        //    //reflMatrix.Reflect(new Plane(0, 1, 0, -water.Height));

    //        //    GEngineState.Lighting.ReflectionEnable = false;
    //        //    var scene = GSceneManager.Scene;
    ...
    //        //    GEngineState.Lighting.ReflectionEnable = true;
    //        //}
    //    }       
