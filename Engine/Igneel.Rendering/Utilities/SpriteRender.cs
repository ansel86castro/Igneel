...
namespace Igneel.Rendering
{
    public class Sprite
    {
        ...
        GraphicBuffer _vb;
        DepthStencilState _state;
        private DepthStencilState _oldState;
        ...
        public void Begin(bool depthWrite = false)
        {
            ...
            _oldState = device.DepthTest;

            if (!depthWrite)
            {              
                device.DepthTest = _state;
            }
            
            device.PrimitiveTopology = IAPrimitive.TriangleStrip;
            var rt = device.GetRenderTarget(0);
            _vp = new ViewPort(0, 0, rt.Width, rt.Height);
        ...
        public void SetTrasform(Effect effect, Rectangle rec, Matrix textureTransform)
        {
            ...
            effect.Input.Transform = transform;
            effect.Input.TexTransform = textureTransform;
        }
        ...
        {
            effect.Input.Transform = new Matrix(2, 0, 0, 0,
                                         0, -2, 0, 0,
                                         0, 0, 1, 0,
                                         -1, 1, 0, 1);
            effect.Input.TexTransform = texture;
        }
        ...
        public void SetFullScreenTransform(Effect effect)
        {
            ...
            effect.Input.TexTransform = Matrix.Identity;
        }
        ...
        public void End()
        {
            GraphicDeviceFactory.Device.DepthTest = _oldState;
        }
