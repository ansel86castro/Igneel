...
{
	public ref class GraphicBuffer10 : public GraphicBuffer ,IResourceContainer
	{
	internal:
	...
	internal:
		GraphicBuffer10(ID3D10Device* device, ID3D10Buffer * _buffer, int size, int stride,  ResourceUsage usage, CpuAccessFlags cpuAcces , D3D10_SUBRESOURCE_DATA* sbData, ResourceBinding binding);
