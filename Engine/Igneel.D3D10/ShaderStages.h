...
namespace IgneelD3D10
{
	...
	protected:
		...
		OVERRIDE(void OnSetResource(int index, IShaderResource^ resource));

		OVERRIDE(void OnSetResources(int index, int nbResources, array<IShaderResource^,1>^ resources));					
