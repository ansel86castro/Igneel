...
{
	Texture1D10::Texture1D10(GraphicDevice10^ graphicDevice, ID3D10Texture1D* texture)
		:Texture1D(graphicDevice)
	{	
		this->device = graphicDevice->_device;
		_texture = texture;		
	...
	Texture1D10::Texture1D10(GraphicDevice10^ graphicDevice, Texture1DDesc desc, array<IntPtr>^ data)
		:Texture1D(graphicDevice, desc)
	{
		this->device = graphicDevice->_device;
